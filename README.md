...
<body>
    ...
    <div class="header" >   
        <div  class="logo" height="100px" >
            ...
            <pre align=""> <img src="megaman.jpg" width="60" align="auto"/ alt="imagem do megaman X"> <a href="https://www.arcadeflix.com.br/2022/05/mega-man-x-snes.html" onMouseOver="this.style.color='#fa0'" onMouseOut="this.style.color='#00a'">JOGOS DE MEGAMAN</a>   <a href="https://xbuster.wordpress.com/2011/06/10/megaman-x-fraquezas-de-chefes/" onMouseOver="this.style.color='#fa0'" onMouseOut="this.style.color='#00a'">CHEFÕES DE MEGAMAN X</a>   <a href="https://youtu.be/UAIfRg7E-ug?si=c27gJBN30D_scxqL" onMouseOver="this.style.color='#fa0'" onMouseOut="this.style.color='#00a'">ARMADURA</a>   <a href="https://youtu.be/ojDq5Rqe3nQ?si=feny2MZY_Eo66xEv" onMouseOver="this.style.color='#fa0'" onMouseOut="this.style.color='#00a'">HADOUKEN E ITENS</a></pre>
        </div>
    </div>
    ...
    <div class="content">
        ...
        <div class="main">
          <h2 id="mega">Mega Man X (jogo eletrônico)</h2>
            ...
            <h2 id="historia">História</h2>
              ...
              <p>Ver artigo principal: Lista de personagens da série X
              ...
              <p>Há cinco cápsulas espalhadas pelas oito primeiras fases do jogo.
        ...
        <div class="anchors">
            <h2>Neste Artigo</h2>
            <figure><img src="CAPA_Mega_Man_X.png" alt="Imagem de Ancora" width="auto" height="130" alt="Imagem do jogo de megaman x"></figure>
    ...
    <div class="footer">
      ...
      <p>
         ...
         The History of Mega Man - Page 10 - Features at GameSpot. 9 de fevereiro de 2010. Consultado em 30 de abril de 2016</p>
         Ligações externas:
          MegarockPage
